...
namespace TechStore
{
    public class TechStoreServer
    {
        private ServiceHost serviceHost;
        private String externalEndpointName = "TechInput";
        public TechStoreServer()
        {
            ...
            serviceHost = new ServiceHost(typeof(TechStoreServerProvider));
            NetTcpBinding binding = new NetTcpBinding();
            serviceHost.AddServiceEndpoint(typeof(ITechStore), binding, endpoint);
        }
        public void Open()
        {
            try
